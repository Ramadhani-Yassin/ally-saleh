        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <div className="mt-8 relative">
              <span className="text-6xl sm:text-7xl lg:text-8xl font-heading text-copper/10 absolute -top-12 left-1/2 -translate-x-1/2 select-none pointer-events-none leading-none">
                &ldquo;
              </span>
              <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl text-soft-white leading-[1.3] italic max-w-3xl mx-auto">
                {tc("aboutHeading1")}{" "}
                <span className="text-gradient not-italic">{tc("aboutHeading1Highlight")}</span>.
                <br />
                {tc("aboutHeading2")}{" "}
                <span className="text-gradient not-italic">{tc("aboutHeading2Highlight")}</span>.
              </h2>
              <div className="w-16 h-0.5 bg-copper/40 mx-auto mt-8" />
            </div>
          </div>
        </ScrollReveal>
                ...
                {roles.map((role) => (
                  <StaggerItem key={role}>
                    <div className="flex items-center gap-2 group">
                      <span className="w-1.5 h-1.5 rounded-full bg-copper/40 group-hover:bg-copper transition-colors flex-shrink-0" />
