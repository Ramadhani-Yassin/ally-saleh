        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <ScrollReveal>
            ...
            <ScrollReveal delay={0.5}>
              <a
                href="#contact"
                className="group inline-flex items-center gap-2 mt-10 px-8 py-4 bg-copper text-rich-black font-medium text-sm tracking-wider uppercase transition-all duration-300 hover:bg-soft-white hover:shadow-[0_0_40px_rgba(184,115,51,0.3)]"
              >
                <Mic size={16} />
                {tc("speakingBtn")}
                <ArrowRight
